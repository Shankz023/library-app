...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (
  ...
  async function increaseQuantity() {
    const url = `${import.meta.env.VITE_API_BASE_URL}/admin/secure/increase/book/quantity/?bookId=${props.book.id}`;
  ...
  async function decreaseQuantity() {
    const url = `${import.meta.env.VITE_API_BASE_URL}/admin/secure/decrease/book/quantity/?bookId=${props.book.id}`;
    const requestOptions = {
        method: `PUT`,
        headers: {
            Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
  ...
  async function deleteBook() {
    const url = `${import.meta.env.VITE_API_BASE_URL}/admin/secure/delete/book/?bookId=${props.book.id}`;
    const requestOptions = {
        method: `DELETE`,
        headers: {
            Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
