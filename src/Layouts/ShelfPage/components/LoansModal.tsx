              ...
              <div className="mt-3">
                ...
                {props.shelfCurrentLoan.daysLeft < 0 && (
                  <p className="text-danger">
                    Due by {Math.abs(props.shelfCurrentLoan.daysLeft)} days.
                  </p>
                )}
                <div className="list-group mt-3">
                  ...
                  <button
                  onClick={props.shelfCurrentLoan.daysLeft<0 ? (event)=>event.preventDefault:()=> props.renewBook(props.shelfCurrentLoan.book.id)}
                    data-bs-dismiss="modal"
                    className={
                      props.shelfCurrentLoan.daysLeft < 0
